...
const Post = ({ post }) => {
  ...
  const handleLike = useCallback(
    (e) => {
      e.preventDefault();
      dispatch(actions.posts.likePost(seq, 1));
    },
    [seq]
  );
  ...
  const handleCommentsClick = () => dispatch(actions.comments.getComments(seq, 1));
      ...
      <div className="card-body">
        <h5 className="card-title">
          ...
          <span className="user-profile" onClick={handleClickUser}>
            <img src={profileImageUrl ? profileImageUrl : null} alt="" />
            {name}
          </span>
        </h5>
        ...
        <div className="card-info">
          <button type="button" className="thumb-count" onClick={handleLike}>
            <i
          ...
          <span className="comment-count" onClick={handleCommentsClick}>
